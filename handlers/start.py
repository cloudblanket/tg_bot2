...
async def callback_help(callback: types.CallbackQuery) -> None:
    ...
    await edit_or_send(
        ...
        "📤 <b>Загрузка</b> (VIP) — загрузи своё видео\n"
        "🗳 <b>Голосование</b> — пропустить, сменить видео\n"
        ...
        "Создатель комнаты может выбрать кто управляет:\n"
        "• <b>Все</b> — каждый может ставить/перематывать\n"
        "• <b>Только я</b> — только создатель\n"
        "• <b>По голосованию</b> — голос за право управления\n\n"
        "🗳 <b>Голосование</b>\n"
        "• ⏭ Пропустить видео\n"
        "• 🎬 Следующее видео\n"
        "• 🎮 Получить управление\n"
        "Голосование проходит при большинстве голосов\n\n"
        "💳 <b>Подписка</b>\n"
        "• Free: 2 чел., YouTube\n"
